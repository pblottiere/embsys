...
````txt
Cela donne accès à tous les périphériques de l'hôte, au deamons etc...
````
...
````txt
Le binaire s'exectue, puisque nous avons émulé une architecture ARM pour lequel il a été compilé
````
