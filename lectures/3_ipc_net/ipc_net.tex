...
\begin{frame}{Descripteur de fichier (3)}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.60]{fd.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Pipe (3)}
    ...
    \onslide<2->{
        \begin{figure}
            \vspace{-20pt}
            \includegraphics[scale=0.7]{pipe_error.png}
        \end{figure}

        \begin{figure}
            \vspace{-100pt}
            \hspace{180pt}\includegraphics[scale=0.4]{tux_why.png}
        \end{figure}
    }
...
\begin{frame}{Pipe (6)}
    ...
    \onslide<2->{
        \begin{figure}
            \includegraphics[scale=0.7]{named_pipe.png}
        \end{figure}
    }
...
\begin{frame}{File de messages (3)}
    ...
    \vspace{-90pt}
    \begin{figure}
        \hspace{80pt} \includegraphics[scale=0.7]{mq.png}
    \end{figure}
...
\begin{frame}{Mémoire partagée (3)}
    ...
    \begin{figure}
        \includegraphics[scale=0.7]{shm.png}
    \end{figure}
