...
\begin{frame}{Outils (1)}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.45]{ps_au.png}
    \end{figure}
    ...
    \onslide<2->{
        ...
        \item TTY : terminal associé. Un \textit{?} si il n'y en a pas
...
\begin{frame}{Outils (4)}
    ...
    \onslide<2->{
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.6]{proc_ex.png}
        \end{figure}
    }
...
\begin{frame}[fragile]{Identification (2)}
    ...
    \lstinputlisting[label=samplecode]{code/pid.c}
...
\begin{frame}{Création de processus (1)}
    ...
    \item a un cout très faible en ressources (mécanisme COW)
    \ei
...
\begin{frame}{Création de processus (2)}
    ...
    \lstinputlisting[label=samplecode, basicstyle=\tiny]{code/fork.c}
...
\begin{frame}{Terminaison d'un processus (1)}
    ...
    \onslide<3-> {
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.6]{code_retour.png}
        \end{figure}
    }
...
\begin{frame}{Terminaison d'un processus (7)}
    ...
    \lstinputlisting[label=samplecode, basicstyle=\tiny]{code/sigaction.c}
...
\begin{frame}{Les pthreads (4)}
    ...
    \lstinputlisting[label=samplecode, basicstyle=\tiny]{code/thread.c}
...
\begin{frame}{Les pthreads (7)}
    ...
    \lstinputlisting[label=samplecode, basicstyle=\tiny]{code/maxthread.c}

    \begin{figure}
        \centering
        \includegraphics[scale=0.6]{maxthread.png}
    \end{figure}
